...
function edux_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $image_folder = drupal_get_path('theme', 'edux') . '/images/theme-settings/';
  $button = "display: inline-block; background: #0984e3; color: white; margin-bottom: 10px; padding: 5px 10px";
  $img_arrow_one = '<img src="/' . $image_folder . 'arrow-one.svg" />';
  $img_arrow_two = '<img src="/' . $image_folder . 'arrow-two.svg" />';
  ...
  $form['general']['general_info_upgrade'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Upgrade To EduX Pro for $29 only'),
    '#description' => t('<a href="https://www.drupar.com/theme/eduxpro" target="_blank">Purchase Edu X Pro</a> || <a href="https://demo2.drupar.com/eduxpro/" target="_blank">EduX Pro Demo</a>'),
  ];
  /*
   * Layout
   */
  ...
  $form['slider']['slider_image_section']['slider_image'] = [
    ...
    '#description'   => t('Edux theme has limitation of single image for slider. Separate image for each slide is available in EduxPro. <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Buy EduX Pro for $29 only.</a>'),
  ];
  ...
  $form['header']['sticky_header'] = [
    ...
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Buy EduX Pro for $29 only.</a>'),
    '#group' => 'header_tab',
  ];
  ...
  $form['content']['animated_content']['animated_content_section'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Animated Page Content - EduX Pro Feature'),
    '#description'   => t('<p>With animated page content shortcodes, you can create contents with animation effects. These contents will appear with some animation effect when it will come in browser view.</p><p>This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Buy EduX Pro for $29 only.</a></p>'),
  ];
  ...
  $form['elements']['breadcrumb']['breadcrumb_icon']['breadcrumb_icon_style'] = [
    ...
    '#default_value' => theme_get_setting('breadcrumb_icon_style', 'edux'),
  ];
  // Elements -> Button
  ...
  $form['components']['social']['node_share'] = [
    '#type'        => 'details',
    '#title'       => t('Share Page'),
    '#description'   => t('<h3>Share Page On Social networking websites</h3><p>This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Buy EduX Pro for $29 only.</a></p>'),
    '#group' => 'components_tab',
  ];
  ...
  $form['components']['scrolltotop']['scrolltotop_default_section']['scrolltotop_default'] = [
    '#type'          => 'checkbox',
    '#title'         => t('Use theme default sidebar block settings.'),
    '#default_value' => theme_get_setting('scrolltotop_default', 'edux'),
    '#description'   => t('Check this option to use theme default value of sidebar block. Uncheck this to set custom value below.'),
  ];
  ...
  $form['components']['scrolltotop']['scrolltotop_icon']['scrolltotop_icon_style'] = [
    ...
    '#default_value' => theme_get_setting('scrolltotop_icon_style', 'edux'),
  ];
  ...
  $form['components']['scrolltotop']['scrolltotop_shape_section']['scrolltotop_icon_size'] = [
    ...
    '#default_value' => theme_get_setting('scrolltotop_icon_size', 'edux'),
  ...
  $form['components']['scrolltotop']['scrolltotop_shape_section']['scrolltotop_icon_radius'] = [
    ...
    '#default_value' => theme_get_setting('scrolltotop_icon_radius', 'edux'),
  ...
  $form['components']['scrolltotop']['scrolltotop_position_section']['scrolltotop_position'] = [
    ...
    '#default_value' => theme_get_setting('scrolltotop_position', 'edux'),
  ...
  $form['components']['scrolltotop']['scrolltotop_position_section']['scrolltotop_bottom'] = [
    ...
    '#default_value' => theme_get_setting('scrolltotop_bottom', 'edux'),
  ...
  $form['insert_codes']['head'] = [
    '#type'        => 'details',
    '#title'       => t('Head'),
    '#description' => t('<h3>Insert Codes Before &lt;/HEAD&gt;</h3><p><hr /></p>This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Buy EduX Pro for $29 only.</a>'),
  ...
  $form['support']['info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Edu X Theme Support'),
    '#description' => t('<h4>Documentation</h4>
    <p>Please check our full documentation for detailed information on how to use Edu X theme.<br /><a href="https://www.drupar.com/doc/edux" target="_blank">Edu X Theme Documentation</a>.</p>
    <hr />
    <h4>Create Issue</h4>
  ...
  $form['upgrade']['info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('<a href="https://demo2.drupar.com/eduxpro/" target="_blank">eduxPro Demo</a> | <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Purchase eduxPro for $29 only</a>'),
  ];
// End form.
}
